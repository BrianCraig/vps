...
var elemento = fragmento('<article><div class="top'+(App.estado?' activo':'')+'"></div><header><h2>'+App.carpeta+'</h2></header><p><b>Hosts: </b>'+App.dominios.join(', ')+'</p><p><b>Puerto Real: </b>'+App.puerto+'</p><p><div class="boton">'+(App.estado?'Terminar':'Inicar')+' el proceso</div></p></article>');
var salida = {};
